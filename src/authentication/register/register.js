      ...
      >
        ...
        <Form.Item label="ยันยันรหัสผ่าน" hasFeedback>
          {getFieldDecorator('confirm', {
            ...
            <Input.Password
              placeholder="กรอกรหัสผ่านอีกครั้งตรงนี้"
        ...
        >
          {getFieldDecorator('nickname', {
            rules: [
              {
                required: true,
                message: 'โปรดกรอกชื่อและนามสกุลจริง',
                whitespace: true,
              },
            ],
        ...
        <Form.Item label="เบอร์โทรศัพท์">
          {getFieldDecorator('phone', {
            rules: [
              { required: true, message: 'กรอกข้อมูลที่เป็นตัวเลขเท่านั้น' },
            ],
        ...
        >
          {getFieldDecorator('Age', {
            rules: [
              {
                required: true,
                message: 'โปรดกรอกอายุเป็นตัวเลข',
                whitespace: true,
              },
            ],
        ...
        >
          {getFieldDecorator('weight', {
            rules: [
              {
                required: true,
                message: 'โปรดกรอกน้ำหนักเป็นตัวเลข',
                whitespace: true,
              },
            ],
        ...
        >
          {getFieldDecorator('heigh', {
            rules: [
              {
                required: true,
                message: 'โปรดกรอกส่วนสูงเป็นตัวเลข',
                whitespace: true,
              },
            ],
